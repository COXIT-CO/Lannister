...
WORKER_REQUEST_MODAL = [
    {
        "type": "header",
        "text": {"type": "plain_text", "text": "Enter your request information: "},
    },
    {
        "type": "input",
        "element": {"type": "plain_text_input", "action_id": "bonus_input_action"},
...
REVIEWER_REQUEST_MODAL = [
    {"type": "header", "text": {"type": "plain_text", "text": "Request information: "}},
    {
        "type": "section",
        "text": {
            "type": "mrkdwn",
